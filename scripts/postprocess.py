...
if __name__ == "__main__":
	variantfile = snakemake.input["variants"]
	...
	compute_probabilities(snakemake.input["posterior"], snakemake.input["population"], snakemake.input["variants"], snakemake.output["prob"], snakemake.wildcards["haplo"])
